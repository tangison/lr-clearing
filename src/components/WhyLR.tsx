    ...
    >
      <div className="mx-auto max-w-7xl px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          >
            <span className="font-mono text-[0.625rem] uppercase tracking-widest text-[var(--color-accent)]">
              Learn more
            </span>
            <p className="font-display font-bold text-lg mt-3 leading-tight">
              Read the full case for choosing L&R.
            </p>
            <span className="font-mono text-[0.6875rem] uppercase tracking-widest text-[var(--color-accent)] mt-4 group-hover:translate-x-1 transition-transform inline-block">
              Why Choose Us →
            </span>
          </a>
        </div>
